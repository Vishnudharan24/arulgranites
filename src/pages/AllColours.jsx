  ...
  return (
    <div className="min-h-screen flex flex-col bg-surface-alt">
      <Helmet>
        ...
        <meta property="og:title" content="Granite Colours | Arul Granites" />
        <meta property="og:description" content="Explore our premium collection of 26 Indian granite colours including Absolute Black, Premium Black, and more." />
        <meta property="og:url" content="https://www.arulgranites.com/colours" />
          ...
          {`
            {
              ...
              "itemListElement": [{
                ...
                "position": 2,
                "name": "Colours",
                "item": "https://www.arulgranites.com/colours"
              }]
            }
          `}
        </script>
      ...
      <main className="flex-1">
        {/* Header Section */}
        <div className="pt-32 pb-16 bg-surface-alt">
          <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center" ref={ref}>
            <h1 className="section-title text-4xl lg:text-5xl text-text-primary mb-6">
              Complete Colour Palette
            </h1>
            <p className="text-text-secondary max-w-2xl mx-auto text-lg leading-relaxed">
              Explore our full range of premium Indian granite colours. We offer
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
              {colourSwatches.map((swatch, i) => (
                <div
                  key={i}
                  className="group relative bg-white overflow-hidden shadow-sm hover:shadow-md transition-shadow animate-fade-in-up"
                  style={{ animationDelay: `${(i % 6) * 100}ms` }}
                >
                  <div className="aspect-square overflow-hidden bg-surface-alt">
                    <img
                      src={swatch.src.replace('./', '/')}
                      alt={`Premium Granite Colour - ${swatch.name}`}
                      className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110"
                      loading="lazy"
                    />
                  </div>
                  {/* Label */}
                  <div className="px-3 py-3 border-t border-border-light text-center bg-white">
